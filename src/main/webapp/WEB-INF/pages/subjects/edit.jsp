...
<t:template>
  ...
  <form:form class="form-horizontal" method="post" action="" commandName="subject" accept-charset="UTF-8">
    ...
    <input type="submit" class="btn btn-success center-block"  value="Edit subject" />
